...
const { createMahasiswa, createDosen, createStaf } = require('../controllers/adminController');
...
router.post('/create-staf', createStaf);
...
router.get('/mahasiswa-tanpa-pengajuan', require('../controllers/adminController').getMahasiswaTanpaPengajuan);
router.get('/mahasiswa-sudah-pengajuan', require('../controllers/adminController').getMahasiswaSudahPengajuan);
